        ...
        <div class="col-lg-12 margin-tb">
            ...
            <div class="card">
                ...
                <div class="card-body no-padding">
                    <div class="row" v-show="acceptedPapers">
                        <div class="col-12 pb-3 pb-3">
                            <p><b>You can upload the final version of the manuscript by clicking on the green pencil</b>
                            </p>
                        </div>
                    </div>
                            ...
                            <tr v-for="(item,k) in renderedPaginate" :key="k">
                                ...
                                <td class="text-right">
                                    ...
                                    <a class="btn btn-success btn-xs"
                                       :href="route('posts.edit', {id: item.id})"
                                       v-if="source==='author' && item.state == 4">
                                        <i class="fas fa-pencil-alt fa-1x fa-lg" aria-hidden="true"></i>
                                    </a>
...
export default {
    ...
    mounted() {
        ...
        this.acceptedPapers = this.checkAcceptedPapers(this.rendered);
        console.log('ACCEPTED '+ this.acceptedPapers);
